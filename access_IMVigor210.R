...
# install.packages("https://github.com/SiYangming/IMvigor210CoreBiologies/releases/download/v2.0.0/IMvigor210CoreBiologies_2.0.0.tar.gz",
#   repos = NULL)
...
# Import count data
read_data <- data.frame(DESeq::counts(cds)) %>%
